...
DEMAND <- read.csv("Data/CA_demand.csv")
DEMAND_OVER <- read.csv("Data/CA_demand_over_5.csv")

################################################################################
################################################################################
################################################################################
HPI <- read.csv("Data/HPIQuartile_TRACT.csv")

TRACTS <- POPULATION_CENTROIDS %>% select(c(GEOID, Pop_over_5_CEN_2010))

### Distance to closest pharmacy
