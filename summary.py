...
def summary(nsplits, capcoef, R=None):
    ...
    partnerships_summary(Model_list=['MNL', 'MaxVaxHPIDistBLP', 'MaxVaxDistLogLin'], Chain_list=['Dollar'], M_list=[5], K_list=[10000], nsplits=nsplits, capcoef=capcoef, R=R, filename='MNL_BLP_R')
