...
for add in "${add_values[@]}"; do
  for random in "${random_values[@]}"; do
        ...
        output_filename="output_log/Pharmacy/Pharmacy_eval_10000_5_4q_mnl_A${add_num}_random${random_num}.txt"
...
#         output_filename="output_log/Summary/randomization/summary_10000_5_4q_mnl_A${add_num}_random${random_num}.txt"
