...
# SUMMARY
# nohup python3 summary.py 10000 5 4 mnl > output_log/Summary/summary_10000_5_4q_mnl.txt & 
...
# OPTIMIZATION UNDER DIFFERENT A
...
# EVALUATION UNDER DIFFERENT A
# for type in "${types[@]}"; do
#     for add in "${adds[@]}"; do
        
#         add_num=$(echo $add | grep -o -E '[0-9]+')
#         # cmd="nohup python3 main.py MNL_partial_new $type 10000 5 4 evaluate mnl '$add' > output_log/$type/MNL_partial_new_eval_10000_5_4q_mnl_A${add_num}.txt &" # MIP
