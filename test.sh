...
#         add_num=$(echo $add | grep -o -E '[0-9]+')
#         cmd="nohup python3 main.py MNL_partial_new $type 10000 5 4 evaluate mnl '$add' > output_log/$type/MNL_partial_new_eval_10000_5_4q_mnl_A${add_num}.txt &"
#         eval $cmd
...
#     add_num=$(echo $add | grep -o -E '[0-9]+')
#     cmd="nohup python3 summary.py 10000 5 4 mnl '$add' > output_log/Summary/partnerships/summary_10000_5_4q_mnl_A${add_num}.txt &"
#     eval $cmd
