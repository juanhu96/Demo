...
#     cmd="nohup python3 main.py MNL_partial_new $type 10000 5 4 optimize mnl > output_log/$type/MNL_partial_new_opt_10000_5_4q_mnl.txt &"
#     eval $cmd
# done


for type in "${types[@]}"; do
    cmd="nohup python3 main.py MNL_partial_new $type 10000 5 4 evaluate mnl > output_log/$type/MNL_partial_new_eval_10000_5_4q_mnl.txt &"
    eval $cmd
done
...
#         add_num=$(echo $add | grep -o -E '[0-9]+')
#         cmd="nohup python3 main.py MNL_partial $type 10000 5 4 evaluate mnl '$add' > output_log/$type/MNL_partial_eval_10000_5_4q_mnl_A${add_num}_test.txt &"
#         eval $cmd
